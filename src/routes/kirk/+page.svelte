				...
				{#if query.data}
					{#each query.data as item}
						<div class="flex flex-row items-center gap-2">
							...
							<button class="aspect-square cursor-pointer rounded-lg border border-green-400">
							...
							<button class="aspect-square cursor-pointer rounded-lg border border-red-400">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
									><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path
